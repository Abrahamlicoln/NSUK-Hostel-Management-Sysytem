...
if (!isset($_GET['succesfullypaid'])) {
    ...
    $insert = "INSERT INTO payment_history(reg_no,invoice_number,payment_status,date_paid) VALUES('$regno','$invoice_number','Success',NOW())";

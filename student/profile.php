...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE  userRegistration set firstName=?,middleName=?,lastName=?,gender=?,phone_number=?,updationDate=? where id=?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssssssi', $fname, $mname, $lname, $gender, $contactno, $udate, $aid);
    $stmt->execute();
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="contact" id="contact" maxlength="10" class="form-control" value="<?php echo $row->phone_number; ?>" required="required">
                            </div>
                        </div>
                    </div>
                </div>

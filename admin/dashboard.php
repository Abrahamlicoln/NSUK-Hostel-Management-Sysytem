...
$title = "Administrator Dashboard | NSUK-HMS";
...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        ...
        <div class="row justify-content-end">
            <div class="col-auto">
                <a href="../assets/images/student.xlsx" class="btn btn-success"><i class="fas fa-file-excel"></i> Download Template</a>
            </div>
        </div>
        ...
        <div class="card-group">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/captured-count.php' ?></h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Captured Student</h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
...
Toast.fire({
  icon: 'success',
  title: 'You have Upload Student in Bulk'
})
        </script>";

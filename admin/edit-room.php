                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                    <select disabled class="custom-select mr-sm-2" id="seater" name="building" required="required">
                                        <option vvalue="<?php echo $row->building; ?>"><?php echo $row->building; ?></option>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="rmno" placeholder="Enter Room Number" readonly value="<?php echo $row->room_no; ?>" id="rmno" class="form-control" required>
                                </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                    <select class="custom-select mr-sm-2" id="seater" name="seater" value="<? echo $row->seater; ?>" required="required">
                                        <option vvalue="<?php echo $row->seater; ?>"><?php echo $row->seater; ?></option>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="number" name="fee" id="fee" placeholder="Enter Total Fees" value="<?php echo $row->fees; ?>" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>

                    ...
                    <div class="container">
                        <div class="row px-4 py-2">
                            ...
                            ?>
                                ...
                                <div class="col-md-2">
                                    <img class="profile_img img-fluid" src="data:image/jpeg;base64,<?php echo $passport; ?>" alt="student dp" width="100px" style="border-radius:10px;">
                                </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12">
                                <center>
                                    <h3 style="font-weight:bolder; color:#18391A;">Student Information</h3>
                                </center>
                            </div>
